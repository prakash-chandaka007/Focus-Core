  ...
  return (
    <div className="min-h-screen bg-[#030303] text-[#f8fafc] font-['Plus_Jakarta_Sans',sans-serif] selection:bg-indigo-500/30 overflow-x-hidden">
      ...
      <nav className={`fixed top-0 left-0 w-full z-[100] transition-all duration-700 ${
        scrolled ? 'bg-black/80 backdrop-blur-2xl py-4 border-b border-white/5 shadow-2xl' : 'bg-transparent py-8 border-b border-transparent'
      }`}>
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-10">
            ...
            <div className="flex items-center gap-6">
              <button className="text-[10px] font-black uppercase tracking-widest text-gray-400 hover:text-white transition-colors">Log In</button>
              <button className="px-7 py-3 bg-white text-black text-[10px] font-black uppercase tracking-[0.2em] rounded-sm hover:bg-indigo-600 hover:text-white transition-all active:scale-95 shadow-lg">
                 Join the Waitlist
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          <div 
            ...
            className={`flex flex-col sm:flex-row gap-4 w-full sm:w-auto transition-all duration-1000 delay-700 ${isVisible('hero-cta') ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
             <button className="group flex items-center justify-center gap-4 px-12 py-6 bg-indigo-600 border border-indigo-400/20 text-xs font-black uppercase tracking-[0.4em] hover:bg-indigo-500 transition-all rounded-sm shadow-[0_20px_40px_-10px_rgba(79,70,229,0.4)] active:scale-95">
                Build Your System <MoveUpRight size={18} className="group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
             </button>
             <button className="flex items-center justify-center gap-4 px-12 py-6 bg-transparent border border-white/10 text-xs font-black uppercase tracking-[0.4em] hover:bg-white hover:text-black transition-all rounded-sm">
                Explore The Method
             </button>
          </div>
        </div>
