        ...
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative p-6 rounded-[32px] bg-white/[0.02] border border-white/5 overflow-hidden group">
                <div className="animate-precision-docking stagger-1">
                    <h3 className="text-3xl font-black text-white tracking-tighter italic uppercase">Mission Directive Log</h3>
            ...
            <div className="grid grid-cols-1 gap-4">
                ...
                {filteredTasks.length === 0 && (
                    <div className="py-24 flex flex-col items-center justify-center text-center bg-white/[0.01] border border-dashed border-white/10 rounded-[48px] animate-precision-docking stagger-4">
                        <div className="w-20 h-20 rounded-full bg-white/5 flex items-center justify-center text-slate-700 mb-6 drop-shadow-[0_0_15px_rgba(255,255,255,0.05)]">
                            <ListTodo size={40} />
                        </div>
                        <p className="text-xl font-black text-slate-600 uppercase italic tracking-widest">Sector Clear</p>
                        <p className="text-slate-500 text-[10px] mt-3 font-black uppercase tracking-[0.3em]">Frequency clear. Awaiting new instructions.</p>
                    </div>
                )}
            </div>
        </div>
