        ...
        <footer className="relative z-10 pt-20 pb-10 px-6 md:px-10 bg-transparent border-t border-white/5 mt-auto">
            <div className="max-w-[1400px] mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-start gap-16 mb-24">
                    ...
                    <div className="grid grid-cols-2 gap-12 md:gap-24">
                        <div className="space-y-6">
                            ...
                            <ul className="space-y-4 text-[10px] font-black text-slate-600 uppercase tracking-[0.2em] list-none">
                                {['Core Directives', 'System Portability', 'Protocol Encryption', 'Data Link Interface'].map(link => (
                                    <li key={link}><a href="#" className="hover:text-indigo-400 transition-colors no-underline italic">{link}</a></li>
                                ))}
                            </ul>
                        </div>
                        <div className="space-y-6">
                            ...
                            <ul className="space-y-4 text-[10px] font-black text-slate-600 uppercase tracking-[0.2em] list-none">
                                {['Privacy Protocol', 'Strategic Roadmap', 'Grid Analytics'].map(link => (
                                    <li key={link}><a href="#" className="hover:text-indigo-400 transition-colors no-underline italic">{link}</a></li>
                                ))}
                            </ul>
                        </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/5 text-[10px] font-black uppercase tracking-[0.3em] md:tracking-[0.6em] text-slate-700 gap-6">
                    <p>© 2026 FOCUS CORE // PERFORMANCE ARCHITECTURE</p>
